...
module.exports = function userVersionCheck (_options) {
    ...
    this.nuxt.hook('build:done', async (builder) => {
        ...
        let resources = {};
        // If we are in a dev mode, and the builder is directly providing us with their manifest resources
        ...
        // When building to production or similar, we need to fetch it manually
